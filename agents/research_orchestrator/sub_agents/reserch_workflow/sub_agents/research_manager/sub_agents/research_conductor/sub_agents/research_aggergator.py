...
from domain import CompressedResearchOutput, ResearchOutput
...
async def compress_research(research_output: ResearchOutput):
    ...
    compressed_research_output = await compressed_research.structured_output_async(
